...
#define buzz 5 
#define flame 16
const char* ssid = "vivo 2018";  
const char* password = "ed87ab62203d";  
...
byte sendEmail()
{
  ...
  Client.println("bGFsYW5hMTljczEyN0Bibm1pdC5pbg=="); //base64, ASCII encoded SMTP Username   
  if (!emailResp()) 
    return 0;

  Serial.println(F("Sending Password"));
  Client.println("V2M4N0pBVTVoUEFwMzBscA==");   //base64, ASCII encoded SMTP Password    
  if (!emailResp()) 
    return 0;
  
  Serial.println(F("Sending From"));
    Client.println(F("MAIL From: IOTfarming@gmail.com"));       
  if (!emailResp())  
    return 0;
  // change to recipient address
  Serial.println(F("Sending To"));
  Client.println(F("RCPT To: lalananagaraj@gmail.com"));    
